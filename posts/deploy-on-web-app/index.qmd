...
description: "In this blog, I am going to show how to deploy a Machine Learning API on Azure App Service."
date: "2022-11-20"
...
Now we have to select a **app service plan**. Most people confusion between web app and app service. App service is the hardware on which you web app is deployed. Single App service can host multiple web apps. Keep this in mind when selecting your app service plan.
...
### Step 3: Push code to the Web App
...
### Step 4: Bonus- Connect it with the front-end.
